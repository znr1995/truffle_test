...
import tweetAccount_artifacts from '../../build/contracts/TweetAccount.json';
import tweetRegistry_artifacts from '../../build/contracts/TweetRegistry.json';
// MetaCoin is our usable abstraction, which we'll use through the code below.
var MetaCoin = contract(metacoin_artifacts);
var TweetAccount = contract(tweetAccount_artifacts);
var TweetRegistry = contract(tweetRegistry_artifacts);
...
window.App = {
  start: function() {
    ...
    TweetAccount.setProvider(web3.currentProvider);
    TweetRegistry.setProvider(web3.currentProvider);
  ...
  sendTweet: function(tweet){
    ...
    TweetAccount.deployed().then(function(instance){
      ...
      tweetAccount.tweet(tweetString).then(function(result){
        if(result == 0)
          alert("tweet send success!");
        else
  ...
  getAllTweet: function(){
        ...
        for(var i=0;i<tweetLength;i++)
        {
          ...
          stringCell.innerText = tweetAccount.getTweet(i);
